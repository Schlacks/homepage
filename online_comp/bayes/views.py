...
def index(request):
    return render ( request, 'C:/Users/Jan/PycharmProjects/Newversion/newattempt/online_comp/templates/bayes/index.html')


def intro(request):
    return render(request,'C:/Users/Jan/PycharmProjects/Newversion/newattempt/online_comp/templates/bayes/intro.html')
...
def create_and_update(request):
    ...
    return render ( request, 'C:/Users/Jan/PycharmProjects/Newversion/newattempt/online_comp/templates/bayes/create_and_update.html',
            {'form': form,
...
def predict(request):
    ...
    return render ( request, 'C:/Users/Jan/PycharmProjects/Newversion/newattempt/online_comp/templates/bayes/predict.html',
            {'form4':form4,
             'predictresult':predictresult,
